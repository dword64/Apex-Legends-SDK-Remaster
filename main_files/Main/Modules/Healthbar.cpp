...
void Modules::Healthbar(BaseEntity pEntity, Matrix m, float distance, LocalEntity pLocal)
{
	...
	int teamindex = pEntity.iTeam();

	if (teamindex == pLocal.iTeam()) // DON'T GLOW ALLIES
		return;
